...
tg_sendinfo "<code>I am gonna merge staging into U-Bot</code>"
cd
...
git push --force origin staging:U-Bot
tg_sendinfo "<code>I have merged all commits from staging into U-Bot</code>"
